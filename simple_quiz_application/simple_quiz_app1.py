...
python_quiz_questions = [
    ...
    {"question": "What is the use of append() function in list", "choices": ["1. It adds an item to the end of the list", "2. It adds an item anywhere in list", "3. It adds an item to the beginning of the list"], "answer": 1}
]
...
while(True):
    ...
    if oper == '1':
        ...
        if len(users) == 0:
            print("You have not yet Registered. Please Register first.")
        ...
        print("**********          Result          **********\n")
        if current_user:
            print(f"{current_user}'s score: {user_scores.get(current_user, 0)}/{len(selected_question)}")
        else:
